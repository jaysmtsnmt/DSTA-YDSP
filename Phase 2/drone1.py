...
model = load_model(r"C:\Users\delay\OneDrive\Documents\Code & Programs\Visual Studio Code\YDSP\DSTA-YDSP\Phase 2\keras_model.h5", compile=False) #load the trained model
class_names = open(r"C:\Users\delay\OneDrive\Documents\Code & Programs\Visual Studio Code\YDSP\DSTA-YDSP\Phase 2\labels.txt", "r").readlines()
...
def main():
	...
	nodeNeighboursList.reverse()	
 
	if (currpadCoords == 26):
		detectMedKid()

		#Backtracking to pad 23
